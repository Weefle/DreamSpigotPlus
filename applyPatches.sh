...
echo
echo "Applying DreamSpigotPlus patches to PaperSpigot-Server and PaperSpigot-API"
echo
applyPatch PaperSpigot-API DreamSpigotPlus-API && applyPatch PaperSpigot-Server DreamSpigotPlus-Server